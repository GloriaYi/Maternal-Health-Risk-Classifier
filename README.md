...
4. To reset the project to a clean state (i.e., remove all files generated by previous runs of the analysis), open a terminal and run the following commands:
```
make clean
```
